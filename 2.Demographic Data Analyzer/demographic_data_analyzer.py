...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors= (len(percentagebachelors)/len(df))*100
    ...
    highest_earning_country = highestearningcountry = df.loc[df['salary'] =='>50K']
    t = highestearningcountry['native-country'].value_counts().head(1)
    highest_earning_country_percentage = (t / len(df)) *100
    


    print(f' Highest Percentage of Earnings:',highest_earning_country_percentage,'%')


    # Identify the most popular occupation for those who earn >50K in India.
    topINoccupation = df.loc[(df['native-country'] == 'India') & (df['salary']== '>50K')]
    top_IN_occupation = topINoccupation['occupation'].value_counts().head(1)
